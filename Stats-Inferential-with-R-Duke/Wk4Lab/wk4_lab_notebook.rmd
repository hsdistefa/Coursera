...
**Yes, the samples appear to be mostly random, the number of positives (atheist response) is > 10 and the number of negatives (non-atheist response) is >> 10.**
...
**The range into which we are confident the actual numbers fall into**
...
inference(y = response, data = filter(atheism, nationality=="Germany", atheism$year=="2012"), statistic = "proportion", type = "ci",
          method = "theoretical", success = "atheist")
inference(y = response, data = filter(atheism, nationality=="India", atheism$year=="2012"), statistic = "proportion", type = "ci",
          method = "theoretical", success = "atheist")
```
...
**False, 95 CI includes 0**
```{r spain-05-12}
# type your code for Question 10 here, and Knit
spain <- atheism %>%
          filter(nationality=="Spain")
inference(y = response, x = as.factor(year), data = spain, statistic = "proportion", type = "ci",
          method = "theoretical", success = "atheist")
```
...
**True, there is convincing evidence it has increased**
```{r us-05-12}
# type your code for Question 11 here, and Knit
us <- atheism %>%
          filter(nationality=="United States")
inference(y = response, x = as.factor(year), data = us, statistic = "proportion", type = "ci",
          method = "theoretical", success = "atheist")
```
